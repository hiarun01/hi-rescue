    ...
    <>
      <section className="py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          {/* Form Container */}
          <div className="bg-transparent border-4 px-5 py-5 rounded-2xl border-gray-100">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="bg-gray-50 p-4 rounded-xl ">
                      ...
                      <textarea
                        ...
                        placeholder="Describe what happened And stay"
                        required
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="bg-gray-50 p-4 rounded-xl space-y-4">
                      <div>
                        ...
                        <div className="min-h-[200px] flex flex-col justify-center items-center px-4 py-6 border-2 border-gray-200 border-dashed rounded-xl bg-white hover:border-teal-600 transition-colors cursor-pointer">
